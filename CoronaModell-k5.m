...
j=0;
 for i=fig_index
  ...
  aktuell_Infizierte_Speicher(1, i*delta_t) = aktuell_Infizierte; %speichert Gesamtinfizierten der einzelnen Tage in einer Matrix
...
save 'k5/Aktuelle_Infizierte_Speicher.txt' a;
save 'k5/Kummulierte_Infizierte_Speicher.txt' b;
close all;